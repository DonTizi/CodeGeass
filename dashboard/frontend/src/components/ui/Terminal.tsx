...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "z-0 h-full w-full rounded-lg border border-zinc-700 bg-[#1a1a1a] overflow-hidden",
        className
      )}
    >
      {/* macOS-style header */}
      <div className="flex items-center gap-2 border-b border-zinc-700 bg-[#2d2d2d] px-4 py-2">
        ...
        {title && (
          <span className="flex-1 text-center text-xs text-zinc-400 font-medium">
            {title}
          </span>
        )}
      </div>
