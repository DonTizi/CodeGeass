...
from models import SchedulerStatus, UpcomingRun, ExecutionResult, ExecutionStatus
...
class SchedulerService:
    ...
    def _core_to_api_result(self, result: CoreResult, task_name: str | None = None) -> ExecutionResult:
    ...
    def run_due_tasks(self, window_seconds: int = 60, dry_run: bool = False) -> list[ExecutionResult]:
        """Run all due tasks."""
